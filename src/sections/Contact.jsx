...
import { SOCIAL_LINKS, EMAILJS_CONFIG } from '../constants/index.jsx';
...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Note: You'll need to configure EmailJS with your actual credentials
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:muhammadyatoof@example.com" className="text-white hover:text-blue-400 transition-colors">
                      muhammadyatoof@example.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white">Gujrat, Pakistan</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white">University of Gujrat</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {SOCIAL_LINKS.map((social) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center gap-3 p-4 bg-white/10 border border-white/20 rounded-lg hover:bg-white/20 transition-colors"
                  >
            ...
            <div className="glass-card">
              <h3 className="text-2xl font-semibold text-white mb-4">Let's Build Something Amazing</h3>
